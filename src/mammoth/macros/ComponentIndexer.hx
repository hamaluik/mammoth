...
class ComponentIndexer {
     ...
     * @param e<Class<mammoth.ecs.Component>> a mammoth.ecs.Component child class (ex: `SoundComponent`)
     */
    macro public static function ID(e:ExprOf<Class<mammoth.ecs.Component>>):ExprOf<Int> {
